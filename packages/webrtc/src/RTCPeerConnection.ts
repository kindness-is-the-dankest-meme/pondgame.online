...
Object.setPrototypeOf(
  ...
  RTCPeerConnectionEventTarget.prototype
);
 ...
 */
NativeRTCPeerConnection.prototype.dispatchEvent = function dispatchEvent(
  event: Event | RTCDataChannelEvent | RTCPeerConnectionIceEvent | RTCTrackEvent
): boolean {
  if (
  ...
  return RTCPeerConnectionEventTarget.prototype.dispatchEvent.call(this, event);
};

export const RTCPeerConnection = NativeRTCPeerConnection;
/**
 *
 * an experiment
 *
